...
Проект компилируется и собирается через консоль.
В Makefile первый параметр указывает на адрес, где находится 
динамическая библиотека.
Информация из файлов 1-5 записывается в файл result.
